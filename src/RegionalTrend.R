...
# png(filename=paste0(plot.path,"GAM_sigchange.png"),width=4.5,height=5,units="in",res=200,type="windows",bg="white")
layout(matrix(1:5,5,1),heights=c(0.75,1,1,1,0.5))
par(family="serif",mar=c(1.25,1,0.5,0.5),oma=c(1,4.5,0.75,1.5));
...
event.lab.cex=0.75
plot(0:1~dates,type="n",ann=F,axes=F,xlim=xlim.val,ylim=ylim.val)
arrows(x0=date.fun("2005-10-01"),y0=0,y1=0.15,code=1,lwd=2,length=0.1)
text(date.fun("2005-10-01"),0.15,"H. Wilma",pos=3,cex=event.lab.cex,srt=0)
arrows(x0=date.fun("2017-09-10"),y0=0,y1=0.15,code=1,lwd=2,length=0.1)
text(date.fun("2017-09-10"),0.15,"H. Irma",pos=3,cex=event.lab.cex,srt=0)
# arrows(x0=date.fun("2017-07-2017"),y0=0,y1=0.20,code=1,lwd=2,length=0.1)
# text(date.fun("2017-07-2017"),0.20,"TS Emily",pos=3,cex=0.5,srt=90)
# arrows(x0=date.fun("2017-10-28"),y0=0,y1=0.25,code=1,lwd=2,length=0.1)
# text(date.fun("2017-10-28"),0.25,"TS Philippee",pos=3,cex=0.5,srt=90)
...
arrows(x0=date.fun("2015-12-01"),y0=0,y1=0.15,code=1,lwd=2,length=0.1,col="Forestgreen")
...
# text(xlim.val[1],0.6,"Flood",xpd=NA)
axis_fun(1,xmaj,xmin,NA)
axis_fun(2,c(0.1,0.4,0.6),c(0.1,0.4,0.6),c("Pulse\nEvents","Drought","Flood"))
box(lwd=1)
