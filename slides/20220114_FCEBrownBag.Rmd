...
### Co-authors
Jim Fourqurean, Stephen Davis, Donatto Surratt, Evelyn E. Gaiser, John S Kominoski, Joseph N. Boyer, Serge Thomas & Chris Madden

### Land Acknowledgment
I'm presenting to you from the former lands of the Calusa. The Everglades, as we know it today, is rich in the history and modern traditions of First Nations including the Calusa, Taino, Tequesta, Mayaimi, Guacata, Jeaga, Miccosukee and Seminole. We pay respect to their Elders past, present and future as we learn from this land.

### Ecosystem Acknowledgment
We acknowledge the diversity of the ecosystems discussed in this system from the iconic Ridge and Slough to the barrier islands and reefs. The south Florida ecosystem are valuable beyond the vast array of ecosystem services it provides. 
...
```{r,out.width="90%",fig.align="center",fig.cap="Total Nitrogen and Total Phosphorus spatial and temporal generalized additive model effects plot. "}

knitr::include_graphics("./plots/GAM_draw_base_both.png")
```
